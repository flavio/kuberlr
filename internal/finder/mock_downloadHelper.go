...
// UpstreamStableVersion provides a mock function with no fields
...
// UpstreamStableVersionForMinor provides a mock function with given fields: major, minor
func (_m *MockdownloadHelper) UpstreamStableVersionForMinor(major uint64, minor uint64) (semver.Version, error) {
	ret := _m.Called(major, minor)

	if len(ret) == 0 {
		panic("no return value specified for UpstreamStableVersionForMinor")
	}

	var r0 semver.Version
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64, uint64) (semver.Version, error)); ok {
		return rf(major, minor)
	}
	if rf, ok := ret.Get(0).(func(uint64, uint64) semver.Version); ok {
		r0 = rf(major, minor)
	} else {
		r0 = ret.Get(0).(semver.Version)
	}
...
// MockdownloadHelper_UpstreamStableVersionForMinor_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpstreamStableVersionForMinor'
type MockdownloadHelper_UpstreamStableVersionForMinor_Call struct {
	*mock.Call
}

// UpstreamStableVersionForMinor is a helper method to define mock.On call
//   - major uint64
//   - minor uint64
func (_e *MockdownloadHelper_Expecter) UpstreamStableVersionForMinor(major interface{}, minor interface{}) *MockdownloadHelper_UpstreamStableVersionForMinor_Call {
	return &MockdownloadHelper_UpstreamStableVersionForMinor_Call{Call: _e.mock.On("UpstreamStableVersionForMinor", major, minor)}
}

func (_c *MockdownloadHelper_UpstreamStableVersionForMinor_Call) Run(run func(major uint64, minor uint64)) *MockdownloadHelper_UpstreamStableVersionForMinor_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockdownloadHelper_UpstreamStableVersionForMinor_Call) Return(_a0 semver.Version, _a1 error) *MockdownloadHelper_UpstreamStableVersionForMinor_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockdownloadHelper_UpstreamStableVersionForMinor_Call) RunAndReturn(run func(uint64, uint64) (semver.Version, error)) *MockdownloadHelper_UpstreamStableVersionForMinor_Call {
	_c.Call.Return(run)
	return _c
}
