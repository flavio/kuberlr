...
// LocalKubectlBinaries provides a mock function with no fields
func (_m *MockiFinder) LocalKubectlBinaries() (KubectlBinaries, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for LocalKubectlBinaries")
	}

	var r0 KubectlBinaries
	var r1 error
	if rf, ok := ret.Get(0).(func() (KubectlBinaries, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() KubectlBinaries); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(KubectlBinaries)
...
// MockiFinder_LocalKubectlBinaries_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LocalKubectlBinaries'
type MockiFinder_LocalKubectlBinaries_Call struct {
	*mock.Call
}

// LocalKubectlBinaries is a helper method to define mock.On call
func (_e *MockiFinder_Expecter) LocalKubectlBinaries() *MockiFinder_LocalKubectlBinaries_Call {
	return &MockiFinder_LocalKubectlBinaries_Call{Call: _e.mock.On("LocalKubectlBinaries")}
}

func (_c *MockiFinder_LocalKubectlBinaries_Call) Run(run func()) *MockiFinder_LocalKubectlBinaries_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockiFinder_LocalKubectlBinaries_Call) Return(_a0 KubectlBinaries, _a1 error) *MockiFinder_LocalKubectlBinaries_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockiFinder_LocalKubectlBinaries_Call) RunAndReturn(run func() (KubectlBinaries, error)) *MockiFinder_LocalKubectlBinaries_Call {
	_c.Call.Return(run)
	return _c
}
